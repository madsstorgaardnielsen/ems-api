...
namespace ems_api.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Workdays",
                columns: new[] { "WorkdayId", "Date", "TimeFrom", "TimeTo", "UserId" },
                values: new object[] { -2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0), new TimeSpan(0, 0, 0, 0, 0), "-1" });

            migrationBuilder.InsertData(
                table: "Workdays",
                columns: new[] { "WorkdayId", "Date", "TimeFrom", "TimeTo", "UserId" },
                values: new object[] { -1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0), new TimeSpan(0, 0, 0, 0, 0), "-1" });
